export default function CardLoader() {
  return (
    <>
      <div role="status" className="cocktail-card w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 animate-pulse">
